...
def evaluate_main():
    ...
    for module in module_list:
        ...
        for cls_type in eval_classes:
            ...
            eval_obj = cls_type()
            person_scores[eval_obj.target_name] = eval_obj.evaluate(sub_ans)
...
class EvalTemplate:
    ...
    def evaluate(self, sub_ans):
        expected = copy.deepcopy(self.run(cor_ans))
        result = copy.deepcopy(self.run(sub_ans))
