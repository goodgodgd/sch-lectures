...
filename = os.path.join(IMG_PATH, "result", "spiderman.jpg")
...
cv2.waitKey()
# filename = os.path.join(IMG_PATH, "result", "spiderman-gray.jpg")
...
# filename = os.path.join(IMG_PATH, "result", "spiderman-bgr.jpg")
...
cv2.waitKey()
# filename = os.path.join(IMG_PATH, "result", "spiderman-hsv.jpg")
# cv2.imwrite(filename, channels)
...
cv2.waitKey()
# filename = os.path.join(IMG_PATH, "result", "spiderman-segment.jpg")
...
cv2.waitKey()
cv2.destroyAllWindows()
filename = os.path.join(IMG_PATH, "result", "spiderman-yuv.jpg")
cv2.imwrite(filename, channels)
