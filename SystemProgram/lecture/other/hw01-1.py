...
hero_actors = {hero: actor for hero, actor in zip(heroes, actor_names)}
...
for newhero in new_heroes:
    if newhero in hero_actors:
        print(f"7. {newhero} was played by {hero_actors[newhero]}")
    else:
        print(f"7. {newhero} has no name")
